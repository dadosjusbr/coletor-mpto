...
class TestParser(unittest.TestCase):
    ...
    def test_aug_2021(self):
        self.maxDiff = None
        # Json com a saida esperada
        with open('src/output_test/expected/expected_08_2021.json', 'r') as fp:
            expected = json.load(fp)

        files = ['src/output_test/sheets/membros-ativos-contracheque-08-2021.ods',
                 'src/output_test/sheets/membros-verbas-indenizatorias-08-2021.ods']

        dados = load(files, '2021', '08', 'src/output_test/sheets')
        result_data = parse(dados, 'mpto/8/2021', '08', '2021')
        # Converto o resultado do parser, em dict
        result_to_dict = MessageToDict(result_data)
